...
- **Prepared moves.** While others play, a move can be planned as usual and kept for one's turn (two at most, the second planned on what the first leaves), with a condition if wanted — dropped if that player builds, sells or lays a link, there or anywhere, in the meantime. It plays after a beat when the turn comes, if the engine still takes it.
