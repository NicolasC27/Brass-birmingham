...
- **Zéro pile et la par exacte : la comparaison n'a pas eu lieu.** Un cerveau est empaqueté en base64 avec une **barre** entre ses réseaux. Un lecteur dont la classe de caractères oublie la barre laisse tomber chaque ligne qui en contient, rend une chaîne qui ne se déballe pas, et les deux camps retombent sur la lecture manuelle. Le résultat affiché fut `+0,00 ± 0,00` et `24/96` pour une par de 24 — deux lectures identiques, parce que c'était deux fois la même. Un écart nul **au centième** et une par touchée **au jeu près** ne sont pas un résultat ; c'est la signature d'une expérience qui ne s'est pas déroulée. Le garde-fou : compter les réseaux effectivement lus de chaque côté et refuser de jouer si l'un est vide ou si les deux chaînes sont égales. (Les essais faits à un seul réseau n'étaient pas touchés : sans barre, rien à perdre.)
