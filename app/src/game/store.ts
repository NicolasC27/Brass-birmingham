...
/** what a lesson lights: slots of the map (their keys), the rest dimmed
 *  — the ones its advice would take first lit strongest, under a lamp;
 *  first alone, a lamp that dims nothing — links and merchants to look
