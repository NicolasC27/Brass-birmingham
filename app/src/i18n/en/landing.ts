...
const landing = {
  ...
  offer: {
    ...
    title: 'The first 100 to join get a year of Premium, free.',
    note: 'For the first 100 confirmed addresses, from the day Premium opens. One per person.',
    ended: 'All 100 founder seats are taken: the waiting list stays open.',
  },
  form: {
  ...
  demo: {
    ...
    text: 'The real table against Mr Watt and Mrs Wedgwood, in your browser: no sign-up, nothing to install.',
    play: 'Play two rounds',
    full: 'Open full screen',
    endKicker: 'End of the taste',
    endTitle: 'That was two rounds.',
    endText: 'The canal era has eight, and then the railway. Take your seat for the closed beta to play the whole line.',
  ...
  confirm: {
    ...
    founder: 'You are passenger no. {rank}: your year of Premium is set aside for when it opens.',
