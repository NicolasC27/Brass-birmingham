...
const platform = {
  ...
  status: {
    playersOnline: '{count} [count|player|players] online',
    playing: '{count} [count|table|tables] in play',
    normalQueue: 'Queue: {count} · ~{minutes} min',
    rankedQueue: 'Ranked: {count} · 2–4 min',
  ...
  code: {
    title: 'Board with a number',
    hint: 'The train number, given by its host.',
    join: 'Board',
  ...
  home: {
    ...
    edition: {
      ...
      games: "{n} [n|game|games] played since Monday",
      best: "The game of the week",
      bestLine: "“{table}” — {name} carried it with {vp} points",
      busiest: "Most assiduous: {name}, {n} [n|game|games].",
    ...
    board: {
      ...
      queue: {
        ...
        others: '{count} [count|other waits|others wait] with you',
        see: 'See the queue',
      },
    },
    modes: {
      normalTitle: 'Normal game',
      normalCopy: 'No stakes. {count} [count|player|players] in queue · ~{minutes} min',
      rankedTitle: 'Ranked game',
      rankedCopy: 'Counts for your rating. {count} [count|player|players] in queue · ~{minutes} min',
      offline: 'Server offline — local mode available',
    },
    rating: {
      value: '{tier} {division} — {lp} [lp|rating point|rating points]',
      valueTop: '{tier} — {lp} [lp|rating point|rating points]',
      placement: 'Placements {done}/{total}',
  ...
  setup: {
    ...
    where: {
      heading: 'Where do we play?',
      localTitle: 'On this device',
      localCopy: 'Alone against the clockwork, or several of you on one screen.',
      onlineTitle: 'Online, at the club',
      onlineCopy: 'A table on the register: your friends board by invitation or with its code.',
      onlineOff: 'The club is closed for now: this table will be played here.',
      signIn: 'Sign the register first to open a table at the club.',
      cta: 'Open the table at the club',
      badge: 'Online table',
      line: 'The table opens at the club — seats are taken in its lobby, and the house rules go with it.',
      failed: 'The club could not open the table. Try again.',
    },
    mode: {
      heading: 'Game mode',
  ...
  play: {
    ...
    idleSignIn: 'Sign the register to enter a queue.',
    idleConnecting: 'Getting the line back…',
    ...
    lineConnecting: 'Getting the line back… the queues open as soon as it holds.',
    ...
    code: {
      title: "The train number",
      copy: "The number a friend handed you puts you aboard their train.",
      notFound: 'Number not found — check with the host.',
    },
    tables: {
      friends: 'Friends',
      rail: 'Rail era',
      ...
      signInCopy: 'Sign the register to see the tables of the house.',
      ...
      board: 'Board',
      freeSeatsCount: '{count} [count|free seat|free seats]',
      freeSeatOne: '1 free seat',
      lastMove: 'Last move',
      eraLength: 'Era length',
      eraShort: 'short',
      ...
      playing: 'to move',
      modeLabel: 'Mode',
      nextDeparture: 'Nearest to leaving',
      nextDepartureHint: 'The table nearest to leaving: {count} [count|passenger|passengers] short.',
      nextDepartureOne: 'The table nearest to leaving: one passenger short.',
      inviteLink: 'Copy the invitation link',
      linkCopied: 'Invitation link copied',
      friendsOnline: 'Friends online',
      noFriendsOnline: 'No friend online right now.',
      sketch: 'The board, in a few strokes',
      searchKey: 'Press / to search',
    },
    offline: {
  ...
  desk: {
    ...
    stranger: {
      ...
      copy: 'Sign the register to find your tables, invitations and friends.',
      signIn: 'Sign the register',
  ...
  profile: {
    ...
    memberSince: 'Club member since {date}',
    cote: 'Rating {rating}',
    season: '{lp} [lp|rating point|rating points] · {season}',
    ...
    manner: {
      ...
      perGame: 'per game · {n} [n|game|games] counted',
      built: 'Tiles laid',
      links: 'Links',
      sold: 'Sales',
    ...
    rivals: {
      ...
      games: { one: '1 game', many: '{n} [n|game|games]' },
    },
    settings: {
  ...
  comptoir: {
    ...
    toastCollected: 'Reward collected — +{count} [count|guinea|guineas]',
    preview: {
  ...
  challenge: {
    ...
    points: "{n} pts",
    best: "Best attempt: {n} [n|point|points]",
    ...
    rules: {
      ...
      links: "At least {n} [n|link|links]",
      linksRail: "At least {n} [n|rail|rails]",
      doubleRails: "{n} double rail [n|action|actions]",
      income: "Income of {n} or more at the close",
      money: "£{n} or more in hand at the close",
      develops: "{n} Develop [n|action|actions] or more",
    },
    era: {
      canal: "canal",
      rail: "rail",
    ...
    board: {
      ...
      signIn: "Sign the register to stand on the week’s board: the office pays the conditions held in guineas.",
  ...
  chronicle: {
    ...
    streak: "{n} [n|win|wins] in a row, the last at “{table}” — the Counter is starting to worry.",
  },
  patents: {
    eyebrow: "Patents",
  ...
  glossary: {
    ...
    terms: {
      ...
      billet: { name: "The train number", def: "The four signs that name a table; a friend gives them to you, they put you aboard." },
  ...
  seasons: {
    ...
    lede: "Every service closed keeps its review: the passengers ahead, the companies, the game of the service.",
    list: "The services",
    current: "running",
    none: "No service in the register.",
    review: "Service review",
    games: "{n} [n|game|games] played this service",
    best: "The game of the service",
