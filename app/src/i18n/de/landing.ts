...
const landing: Dict['landing'] = {
  ...
  hero: {
    ...
    plate: 'Tafel I — die Kanalzeit',
    alt: 'Das Blackrail-Brett in der Kanalzeit: Städte der Midlands, Miniaturfabriken und Kanäle auf gemalter Landschaft',
  },
  offer: {
    badge: 'Gründerangebot',
    title: 'Die ersten 100 Anmeldungen: ein Jahr Premium gratis.',
    note: 'Für die ersten 100 bestätigten Adressen, ab dem Start von Premium. Eines pro Person.',
    ended: 'Alle 100 Gründerplätze sind vergeben: Die Warteliste bleibt offen.',
  },
  form: {
  ...
  demo: {
    alpha: 'Alpha — Demo mit zwei Runden',
    you: 'Du',
    kicker: 'Jetzt ausprobieren',
    title: 'Zwei Runden, genau hier.',
    text: 'Der echte Tisch gegen Mr Watt und Mrs Wedgwood, im Browser: ohne Anmeldung, nichts zu installieren.',
    play: 'Zwei Runden spielen',
    full: 'Im Vollbild öffnen',
    endKicker: 'Ende der Kostprobe',
    endTitle: 'Das waren zwei Runden.',
    endText: 'Die Kanalzeit hat acht, danach kommt die Eisenbahn. Sichere dir deinen Platz in der geschlossenen Beta, um die ganze Linie zu spielen.',
    ticket: 'Mein Ticket',
  ...
  twist: {
    ...
    title: 'Ende der Kanalzeit: Das erste Netz kommt auf den Schrott.',
    ...
    canalCaption: 'Die Kanalzeit',
    railLabel: 'Die Eisenbahnzeit',
    canalAlt: 'Das Brett in der Kanalzeit: ein Netz farbiger Kanäle verbindet die Städte',
    ceremonyAlt: 'Die Wertung am Epochenende: „Und so weicht das Wasser dem Dampf…“, die Punkte jedes Spielers',
    ceremonyCaption: 'Die Wertung der Kanalzeit',
    railAlt: 'Das Brett in der Eisenbahnzeit: Bahnlinien verbinden die Städte',
    railCaption: 'Die Eisenbahnzeit: das Feld geräumt, das Rennen beginnt von vorn',
  },
  economy: {
  ...
  confirm: {
    ...
    founder: 'Du bist Reisender Nr. {rank}: Dein Jahr Premium ist für den Start reserviert.',
