...
const platform: typeof enPlatform = {
  ...
  desk: {
    ...
    tutorial: {
      title: 'Neu im Club?',
      copy: 'Eine erste geführte Partie: die Kanalzeit gegen eine sanfte Maschine, der Guide an Ihrer Seite für die ersten Züge.',
  ...
  arrival: {
    ...
    line3: "Nehmen Sie zuerst den Abendkurs: eine kurze Lektion, der Guide daneben. Oder treten Sie ein, wenn Sie das Haus schon kennen.",
