...
const platform = {
  ...
  setup: {
    ...
    where: {
      ...
      onlineCopy: 'Una mesa abierta en el registro: tus amigos suben por invitación o con su código.',
      onlineOff: 'El club está cerrado por ahora: esta mesa se jugará aquí.',
      signIn: 'Firma primero el registro para abrir una mesa en el club.',
      ...
      failed: 'El club no pudo abrir la mesa. Inténtalo de nuevo.',
    },
    mode: {
  ...
  play: {
    ...
    tables: {
      ...
      board: 'Subir a bordo',
      freeSeatsCount: '{count} plazas libres',
      ...
      nextDepartureHint: 'La mesa más cerca de salir: faltan {count} viajeros.',
  ...
  profile: {
    ...
    settings: {
      ...
      portrait: 'Tu retrato',
      portraitHint: 'Una pequeña imagen cuadrada, mostrada en tu asiento en las mesas. Se queda en el club.',
  ...
  seasons: {
    ...
    games: "{n} partidas jugadas este servicio",
