...
const es: typeof enHome = {
  hero: {
    ariaTitle: 'Pantalla de título de Blackrail',
    wordmark: 'Blackrail',
    ...
    online: 'Firme el registro y juegue',
    onlineNote: 'Abra una mesa, invite a sus amigos por su nombre, toque la campana. Sus partidas le esperan en la oficina.',
    practice: 'Entrenar contra la máquina',
    tutorial: '¿Nuevo aquí? Una primera partida guiada',
    enterDesk: 'Intro para ir a la oficina',
    quickNote: 'Usted contra {a} y {b}, dos rivales mecánicos. La mesa ya está puesta.',
  ...
  triptych: {
    ...
    rows: {
      ...
      supply: {
        ...
        body: 'El carbón viaja por su propia red, o sale caro en el mercado. Unas líneas fantasma muestran de dónde viene cada cubo.',
      },
    },
  },
  how: {
    ...
    step: 'Paso {n}',
    card: { title: 'Jugar una carta', body: 'Una carta de lugar o de industria abre la acción: construir, red, desarrollar, vender, préstamo o explorar. Dos acciones por turno.' },
    build: { title: 'Construir y conectar', body: 'Coloque sus fábricas en las ciudades, trace canales y luego vías férreas entre ellas. El carbón y el hierro viajan por su red, o salen caros en el mercado.' },
    sell: { title: 'Vender y puntuar', body: 'Una fábrica vendida se voltea: da puntos y sube sus ingresos. Dos eras, dos recuentos, y quien más puntos tenga gana.' },
  },
  footer: {
    tagline: 'Canales, carbón y hierro. Construya el imperio que construyó el mundo.',
