...
const landing: Dict['landing'] = {
  ...
  offer: {
    badge: 'Offre des fondateurs',
    title: 'Les 100 premiers inscrits : un an de Premium offert.',
    note: 'Pour les 100 premières adresses confirmées, dès l’ouverture du Premium. Une par personne.',
    ended: 'Les 100 places fondateur sont prises : la liste d’attente reste ouverte.',
  },
  form: {
  ...
  demo: {
    ...
    text: 'La vraie table contre Mr Watt et Mrs Wedgwood, dans votre navigateur : sans inscription, rien à installer.',
    play: 'Jouer deux manches',
    full: 'Ouvrir en plein écran',
    endKicker: 'Fin de l’essai',
    endTitle: 'Voilà deux manches.',
    endText: 'L’ère des canaux en compte huit, et le rail vient après. Prenez votre place pour la bêta fermée pour jouer toute la ligne.',
    ticket: 'Prendre mon billet',
    again: 'Rejouer',
  },
  table: {
  ...
  confirm: {
    ...
    founder: 'Vous êtes le voyageur n° {rank} : votre année de Premium est réservée pour son ouverture.',
