    ...
    case "develop":
      return (
        <svg viewBox="0 0 220 84" className="h-20 w-full max-w-[260px]" aria-hidden>
          ...
          <text x="150" y="40" fontSize="9" fill={rust} fontFamily="Inter, Archivo, sans-serif">{t("rules.actionsUi.diagram.minusIron")}</text>
          <text x="150" y="52" fontSize="9" fill={ink} fontFamily="Inter, Archivo, sans-serif">{t("rules.actionsUi.diagram.perTile")}</text>
        </svg>
      );
    case "sell":
      return (
        <svg viewBox="0 0 220 84" className="h-20 w-full max-w-[260px]" aria-hidden>
          ...
          <text x="100" y="12" textAnchor="middle" fontSize="8" fill={ink} fontFamily="Inter, Archivo, sans-serif">{t("rules.actionsUi.diagram.beer")}</text>
    ...
    <Accordion type="single" collapsible className="space-y-2">
      {actions.map((a) => (
        <AccordionItem
          key={a.id}
          value={a.id}
          className="overflow-hidden rounded-lg border border-brass-hairline bg-enamel-800 last:border-b"
        >
