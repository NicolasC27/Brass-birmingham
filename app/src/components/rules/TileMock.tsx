...
export default function TileMock({ icon, level, income, vp, className }: TileMockProps) {
  ...
  return (
    ...
    >
      ...
      {/* chips */}
      <span className="absolute -bottom-[7px] left-1 rounded-sm border border-brass-700 bg-[rgb(var(--brass-plate))] px-1 font-mono text-[10.5px] font-semibold leading-[14px] text-[rgb(var(--ink-on-brass))]">
        +{income}
      </span>
      <span className="absolute -bottom-[7px] right-1 rounded-sm border border-ink-900/40 bg-cream-300 px-1 font-mono text-[10.5px] font-semibold leading-[14px] text-ink-900">
