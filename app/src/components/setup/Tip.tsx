  ...
  return (
    <span className={cn("group/tip relative inline-flex", className)}>
      ...
      <span
        role="tooltip"
        className={cn(
          "pointer-events-none absolute left-1/2 z-40 w-56 max-w-[260px] -translate-x-1/2 border border-brass-hairline-strong bg-enamel-800/95 px-3 py-2 text-left font-ui text-[12.5px] font-normal normal-case leading-snug tracking-normal text-paper-300 opacity-0 shadow-e3 transition-all duration-150",
